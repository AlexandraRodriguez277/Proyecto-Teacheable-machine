...
<head>
    ...
    <link rel="stylesheet" href="[https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css](https://teachablemachine.withgoogle.com/models/eHgGYtTwnj/)">
    <style>
        :root {
            --primary: #0a1428;
            --secondary: #091428;
